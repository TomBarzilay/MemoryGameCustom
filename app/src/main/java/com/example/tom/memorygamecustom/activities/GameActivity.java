...
import com.example.tom.memorygamecustom.adapters.GameScreenAdapter;
import com.example.tom.memorygamecustom.helpers.GameRules;
import com.example.tom.memorygamecustom.R;
import com.example.tom.memorygamecustom.helpers.SaveMemoryTask;
...
public class GameActivity extends AppCompatActivity {
    ...
    public void init() {
        ...
        if (images!=null){gridView.setAdapter(new GameScreenAdapter(GameActivity.this, count, height / getRowNumber(), gameRules));}
    ...
    public void pushTheDrawables(Drawable[] drawables) {
        ...
        gridView.setAdapter(new GameScreenAdapter(GameActivity.this, count, height / getRowNumber(), gameRules));
    }
